 ...
 *
 * Receives config by reference so that screens added after boot()
 * (e.g. via BackendUI::playground()) are picked up automatically
 * without needing to re-register the admin_enqueue_scripts hook.
 */
class AssetsManager
{
